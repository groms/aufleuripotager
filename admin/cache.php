          ...
          <tr>
            <td valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr class="dataTableHeadingRow">
                <td class="dataTableHeadingContent"><? echo TABLE_HEADING_CACHE; ?></td>
                <td class="dataTableHeadingContent" align="right"><? echo TABLE_HEADING_DATE_CREATED; ?></td>
...
<?
  if ($messageStack->size < 1) {
    ...
    for ($i=0, $n=sizeof($cache_blocks); $i<$n; $i++) {
      ...
      if (file_exists($admin_FS_path . DIR_FS_CACHE . $cached_file)) {
...
?>
              <tr class="dataTableRow" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)">
                <td class="dataTableContent"><? echo $cache_blocks[$i]['title']; ?></td>
                <td class="dataTableContent" align="right"><? echo $cache_mtime; ?></td>
                <td class="dataTableContent" align="right"><? echo '<a href="' . tep_href_link(FILENAME_CACHE, 'action=reset&block=' . $cache_blocks[$i]['code'], 'NONSSL') . '">' . tep_image(DIR_WS_IMAGES . 'icon_reset.gif', 'Reset', 13, 13) . '</a>'; ?>&nbsp;</td>
              </tr>
<?
    }
  }
?>
              <tr>
                <td class="smallText" colspan="3"><? echo TEXT_CACHE_DIRECTORY . ' ' . DIR_FS_CACHE; ?></td>
              </tr>
            </table></td>
          </tr>
        </table></td>
