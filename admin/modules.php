          ...
          <tr>
            <td valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr class="dataTableHeadingRow">
                <td class="dataTableHeadingContent"><? echo TABLE_HEADING_MODULES; ?></td>
                <td class="dataTableHeadingContent" align="right"><? echo TABLE_HEADING_SORT_ORDER; ?></td>
...
<?
  ...
  for ($i=0, $n=sizeof($directory_array); $i<$n; $i++) {
    ...
    include($admin_FS_path . DIR_FS_CATALOG_LANGUAGES . $language . '/modules/' . $module_type . '/' . $file);
...
?>
                <td class="dataTableContent"><? echo $module->title; ?></td>
...
?>
              <tr>
                <td colspan="3" class="smallText"><? echo TEXT_MODULE_DIRECTORY . ' ' . $module_directory; ?></td>
              </tr>
            </table></td>
<?
  $heading = array();
          ...
          if ($value['use_function']) {
            ...
            if (ereg('->', $use_function)) {
              ...
              if (!is_object(${$class_method[0]})) {
                include($admin_FS_path . DIR_WS_CLASSES . $class_method[0] . '.php');
