    ...
    <td width="100%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            <td class="pageHeading"><? echo $cfg_group['configuration_group_title']; ?></td>
          ...
          <tr>
            <td valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr class="dataTableHeadingRow">
                <td class="dataTableHeadingContent"><? echo TABLE_HEADING_CONFIGURATION_TITLE; ?></td>
                <td class="dataTableHeadingContent"><? echo TABLE_HEADING_CONFIGURATION_VALUE; ?></td>
...
?>
                <td class="dataTableContent"><? echo $configuration['configuration_title']; ?></td>
                <td class="dataTableContent"><? echo htmlspecialchars($cfgValue); ?></td>
