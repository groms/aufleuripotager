          ...
          <tr>
            <td valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr class="dataTableHeadingRow">
                <td class="dataTableHeadingContent"><? echo TABLE_HEADING_ONLINE; ?></td>
                <td class="dataTableHeadingContent" align="center"><? echo TABLE_HEADING_CUSTOMER_ID; ?></td>
                <td class="dataTableHeadingContent"><? echo TABLE_HEADING_FULL_NAME; ?></td>
                <td class="dataTableHeadingContent" align="center"><? echo TABLE_HEADING_IP_ADDRESS; ?></td>
                <td class="dataTableHeadingContent"><? echo TABLE_HEADING_ENTRY_TIME; ?></td>
                <td class="dataTableHeadingContent" align="center"><? echo TABLE_HEADING_LAST_CLICK; ?></td>
                <td class="dataTableHeadingContent"><? echo TABLE_HEADING_LAST_PAGE_URL; ?>&nbsp;</td>
              </tr>
<?
...
?>
                <td class="dataTableContent"><? echo gmdate('H:i:s', $time_online); ?></td>
                <td class="dataTableContent" align="center"><? echo $whos_online['customer_id']; ?></td>
                <td class="dataTableContent"><? echo $whos_online['full_name']; ?></td>
                <td class="dataTableContent" align="center"><? echo $whos_online['ip_address']; ?></td>
                <td class="dataTableContent"><? echo date('H:i:s', $whos_online['time_entry']); ?></td>
                <td class="dataTableContent" align="center"><? echo date('H:i:s', $whos_online['time_last_click']); ?></td>
                <td class="dataTableContent"><? if (eregi('^(.*)' . tep_session_name() . '=[a-f,0-9]+[&]*(.*)', $whos_online['last_page_url'], $array)) { echo $array[1] . $array[2]; } else { echo $whos_online['last_page_url']; } ?>&nbsp;</td>
              </tr>
<?
  }
?>
