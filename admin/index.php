...
*/
  ...
  $cat = array(
               array('title' => 'Aufleuripotager',
                     'image' => 'reports.gif',
                     'href' => tep_href_link(FILENAME_STATS_MANUFACTURERS, 'selected_box=reports'),
                     'children' => array(array('title' => 'Ventes producteurs', 'link' => tep_href_link(FILENAME_STATS_MANUFACTURERS, 'selected_box=reports&gID=1')),
                                         array('title' => BOX_HEADING_CATALOG, 'link' => tep_href_link(FILENAME_CATEGORIES, 'selected_box=catalog')),
                                         array('title' => BOX_CATALOG_MANUFACTURERS, 'link' => tep_href_link(FILENAME_MANUFACTURERS, 'selected_box=catalog')),
                                         array('title' => BOX_CUSTOMERS_CUSTOMERS, 'link' => tep_href_link(FILENAME_CUSTOMERS, 'selected_box=customers')),
...
*/
               ...
               array('title' => BOX_HEADING_REPORTS,
                     ...
                     'children' => array(array('title' => 'Produits les + consultés', 'link' => tep_href_link(FILENAME_STATS_PRODUCTS_VIEWED, 'selected_box=reports')),
                                         array('title' => '<br>Produits les + achetés', 'link' => tep_href_link(FILENAME_STATS_PRODUCTS_PURCHASED, 'selected_box=reports')),
                                         array('title' => '<br>Les + gros adhérents', 'link' => tep_href_link(FILENAME_STATS_CUSTOMERS, 'selected_box=reports')))),
      ...
      <tr bgcolor="#000000">
        <td><table border="0" width="600" height="440" cellspacing="0" cellpadding="0">
          <tr bgcolor="#ffffff" height="50">
            <td height="50"><? echo tep_image(DIR_WS_IMAGES . 'oscommerce.gif', 'osCommerce', '204', '50'); ?></td>
            <td align="right" class="text" nowrap><? echo '<a href="' . tep_href_link(FILENAME_DEFAULT) . '">' . HEADER_TITLE_ADMINISTRATION . '</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="' . tep_catalog_href_link() . '">' . HEADER_TITLE_ONLINE_CATALOG . '</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="http://www.oscommerce.com" target="_blank">' . HEADER_TITLE_SUPPORT_SITE . '</a>'; ?>&nbsp;&nbsp;</td>
          </tr>
          <tr bgcolor="#080381">
...
<?
  ...
  $heading[] = array('params' => 'class="menuBoxHeading"',
                     'text'  => 'osCommerce');
  $contents[] = array('params' => 'class="infoBox"',
                      'text'  => '<a href="http://www.oscommerce.com" target="_blank">' . BOX_ENTRY_SUPPORT_SITE . '</a>' );
/*
                ...
                <td width="460"><table border="0" width="460" height="390" cellspacing="0" cellpadding="2">
                  <tr>
                    <td colspan="2"><table border="0" width="100%" cellspacing="0" cellpadding="2">
                      <tr><? echo tep_draw_form('languages', 'index.php', '', 'get'); ?>
                        <td class="heading"><? echo HEADING_TITLE; ?></td>
                        <td align="right"><? echo tep_draw_pull_down_menu('language', $languages_array, $languages_selected, 'onChange="this.form.submit();"'); ?></td>
                      </form></tr>
                    </table></td>
                  </tr>
<?
...
?>
      ...
      <tr>
        <td><? require($admin_FS_path . DIR_WS_INCLUDES . 'footer.php'); ?></td>
      </tr>
    </table></td>
  </tr>
</table>
