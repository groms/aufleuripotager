...
<?
  ...
  $heading[] = array('text'  => BOX_HEADING_REPORTS,
                     'link'  => tep_href_link(FILENAME_STATS_MANUFACTURERS, 'selected_box=reports'));

  if ($selected_box == 'reports') {
    $contents[] = array('text'  =>  '<a href="' . tep_href_link(FILENAME_STATS_MANUFACTURERS, '', 'NONSSL') . '" class="menuBoxContentLink"><b>' . BOX_REPORTS_SALES_MANUFACTURERS . '</b></a><br>' .
