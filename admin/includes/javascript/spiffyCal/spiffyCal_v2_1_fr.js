...
//	this.Holidays = new Array("Dec-25","Jul-4", "Feb-14","Mar-17","Oct-31");
	this.Holidays = new Array("Jan-1", "Déc-25","Août-15","Juil-14","Mai-1","Mai-8","Nov-1","Nov-11");
//	this.HolidaysDesc = new Array("Christmas Day","Independance Day","Valentine's Day","St. Patrick's Day","Halloween");
	this.HolidaysDesc = new Array("1er janvier","Noël","15 août","14 juillet","1er mai","8 mai","1er novembre","11 novembre");
...
//	var MONTH_NAMES = new Array('January','February','March','April','May','June','July','August','September','October','November','December','Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec');
  var MONTH_NAMES = new Array('Janvier','Février','Mars','Avril','Mai','Juin','Juillet','Août','Septembre','Octobre','Novembre','Décembre','Jan','Fév','Mar','Avr','Mai','Juin','Juil','Août','Sep','Oct','Nov','Déc');
...
*/
		var rangeMsg = 'Vous ne pouvez entrez des dates comprises uniquement entre :\n\n   '+
					strStart+'\n\net\n\n   '+strEnd;
...
//					var Msg='You have entered an ambiguous date.\n\n Click OK for:\n'+ choice1 +'\n\nor Click Cancel for:\n'+choice2;
					var Msg='Vous avez entré un date ambigüe.\n\n Cliquer OK pour :\n'+ choice1 +'\n\nou cliquer Annuler pour :\n'+choice2;
					if (confirm(Msg)) {
						bOK=true;
					}
					else {
		...
		if (bOK==true) {
			...
			if (dStartDate!=null) {
				...
				if (dStartDate>dThis){
					...
					if (this.showHelpAlerts) { alert(rangeMsg + 'antérieure à '+ strStart + '.');}
					eInput.focus();
					eInput.select();
					return false;
				}
			...
			if (dEndDate!=null) {
				...
				if (dEndDate<dThis) {
					eInput.className = "cal-TextBoxInvalid";
					if (this.showHelpAlerts) {  alert(rangeMsg +'postérieure à '+ strEnd + '.');}
					eInput.focus();
					eInput.select();
					return false;
				}
			...
			if (bRequired && bIsEmpty) {
				eInput.className = "cal-TextBoxInvalid";
				if (this.showHelpAlerts) {
					alert('Le champ de date est obligatoire.\n\nVeuillez rentrer une date valide avant de continuer.');
				}
			}
			else {
				if (!bRequired && bIsEmpty) {
...
//	var msNames     = new makeArray0('Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec');
	var msNames     = new makeArray0('Jan','Fév','Mar','Avr','Mai','Juin','Juil','Août','Sep','Oct','Nov','Déc');
...
//	var msDOW       = new makeArray0('L','M','M','J','V','S','D');
