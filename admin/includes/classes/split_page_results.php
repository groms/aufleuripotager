...
*/
  ...
  class splitPageResults {
    function splitPageResults(&$current_page_number, $max_rows_per_page, &$sql_query, &$query_num_rows, $add_field_counter = '') {
      ...
      if ($add_field_counter != '') {
        $sql .= " group by " . $add_field_counter;
      }
      $reviews_count_query = tep_db_query($sql);
