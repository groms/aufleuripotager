...
define('HEADING_TITLE_STATUS', '<font color="0000FF"><b>Etat:</font></b>');

define('TABLE_HEADING_INVOICE_NUMBER', 'Facture n° ');
define('TABLE_HEADING_DATE', 'Date / Heure');
define('TABLE_HEADING_ORDER_STATUS', 'Etat');
define('TABLE_HEADING_CLIENT_DETAILS', 'Détails client');
define('TABLE_HEADING_ORDERS_DETAILS', 'Détails commande');
...
define('TEXT_SELECT_STATUS', ' > Selectionner état <');
define('TEXT_SELECT_CLIENT', ' > Selectionner adhérent < ');
