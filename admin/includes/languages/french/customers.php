...
define('HEADING_TITLE', 'Adhérents');
...
define('TEXT_DELETE_INTRO', 'Etes vous sur de vouloir supprimer cet adhérent?');
define('TEXT_DELETE_REVIEWS', 'Supprimer %s critique(s)');
define('TEXT_INFO_HEADING_DELETE_CUSTOMER', 'Supprimer adhérent');
