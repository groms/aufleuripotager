...
define('DATE_FORMAT', 'd/m/Y'); // this is used for date() // changed on sept., 5th 2010
...
define('BOX_CATALOG_MANUFACTURERS', 'Producteurs');
...
define('BOX_HEADING_CUSTOMERS', 'Adhérents');
define('BOX_CUSTOMERS_CUSTOMERS', 'Adhérents');
...
define('BOX_REPORTS_ORDERS_TOTAL', 'Total de commande adhérent');
...
define('JS_PRODUCTS_DESCRIPTION', '* Le nouveau necessite une description\n');
...
define('JS_ADDRESS', '* L\'entr&eacute;e \'Adresse\' doit avoir au moins ' . ENTRY_STREET_ADDRESS_MIN_LENGTH . ' caract&egrave;res.\n');
...
define('TEXT_DISPLAY_NUMBER_OF_CUSTOMERS', 'Affiche <b>%d</b> &agrave; <b>%d</b> (sur <b>%d</b> adhérents)');
...
define('TEXT_DISPLAY_NUMBER_OF_MANUFACTURERS', 'Affiche <b>%d</b> &agrave; <b>%d</b> (sur <b>%d</b> producteurs)');
...
define('TEXT_CACHE_MANUFACTURERS', 'Bo&icirc;te producteurs');
...
define('BOX_REPORTS_SALES_MANUFACTURERS', 'Ventes producteurs');
?>
