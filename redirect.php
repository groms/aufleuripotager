...
// no url exists, in any language = redirection to manufacturer_info page
        tep_redirect(tep_href_link(FILENAME_MANUFACTURERS_INFO, 'manufacturers_id='.$HTTP_GET_VARS['manufacturers_id']));
      }
      break;
  }
