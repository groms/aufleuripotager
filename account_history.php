...
<?php
  ...
  if ($orders_total > 0) {
    $history_query_raw = "select o.orders_id, o.orders_status, o.date_purchased, o.delivery_name, o.billing_name, ot.text as order_total, s.orders_status_name from " . TABLE_ORDERS . " o, " . TABLE_ORDERS_TOTAL . " ot, " . TABLE_ORDERS_STATUS . " s where o.customers_id = '" . (int)$customer_id . "' and o.orders_id = ot.orders_id and ot.class = 'ot_total' and o.orders_status = s.orders_status_id and s.language_id = '" . (int)$languages_id . "' order by orders_id DESC";
...
?>
          ...
          <table border="0" width="100%" cellspacing="1" cellpadding="2" class="infoBox">
            <tr style="<?=getBgColor($history['orders_status'])?>">
