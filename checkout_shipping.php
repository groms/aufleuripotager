...
// if the customer is not logged on, redirect them to the login page
  ...
  //CJ : FILENAME_CHECKOUT_ALTERNATIVE désactivé pour l'instant : l'utilisateur doit être loggé ! 
    tep_redirect(tep_href_link(FILENAME_LOGIN, '', 'SSL'));
//    tep_redirect(tep_href_link(FILENAME_CHECKOUT_ALTERNATIVE, '', 'SSL'));  //by CJ
  }
...
// following line commented by CJ
