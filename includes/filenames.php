...
// define the filenames used in the project
  ...
  define('FILENAME_CREATE_ACCOUNT_AVEC', 'create_account_avec.php');
  ...
  define('FILENAME_MANUFACTURERS_INFO', 'manufacturers_info.php');
  ...
  define('FILENAME_RECURRENT_ORDER', 'recurrent_order.php');
