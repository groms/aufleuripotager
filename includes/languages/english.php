...
define('BOX_MANUFACTURER_INFO_HOMEPAGE', '<b>%s</b> Info');
...
define('BOX_MANUFACTURERS_INFO', 'Our manufacturers');
...
define('ENTRY_PASSWORD_ERROR', 'Your Password is incorrect, you cannot create a new account.');
