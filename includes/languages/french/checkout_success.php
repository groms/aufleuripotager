...
define('TEXT_SUCCESS', 'Votre commande vient d\'&ecirc;tre prise en compte avec succ&egrave;s!<br><br>
            Vos produits seront disponibles, aux dates indiqu&eacute;es dans votre commande, <b>aufleuripotager</b>.');
...
define('TEXT_CONTACT_STORE_OWNER', 'Veuillez poser toutes les questions directement au <a href="' . tep_href_link(FILENAME_CONTACT_US) . '">webmaster</a>.');
