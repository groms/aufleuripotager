<?php
/*
  $Id: french.php,v 1.114 2003/07/09 18:13:39 dgw_ Exp $
...
@setlocale(LC_TIME, 'fr_FR@euro'); //mod by CJ
...
define('BOX_HEADING_MANUFACTURERS', 'Producteurs');
...
define('BOX_REVIEWS_NO_REVIEWS', 'Il n\'y a actuellement aucune critiques pour ce produit');
...
// recurrent_orders box text in includes/boxes/recurrent_orders.php
define('BOX_HEADING_CUSTOMER_RECURRENT_ORDERS', 'Commandes récurrentes');
...
define('BOX_HEADING_MANUFACTURER_INFO', 'Information producteur');
define('BOX_MANUFACTURER_INFO_HOMEPAGE', '<b>%s</b>');
...
define('CATEGORY_ADDRESS', 'Votre addresse');
...
define('ENTRY_PASSWORD_ERROR', 'Votre mot de passe est incorrect, vous ne pouvez donc pas créer de nouveau compte.');
...
define('ENTRY_COUNTRY_ERROR', 'Veuillez choisir un pays à partir de la liste d&eacute;roulante.');
...
define('ENTRY_PASSWORD_CURRENT', 'Mot de passe courant:');
...
define('IMAGE_BUTTON_ADD_ADDRESS', 'Ajouter addresse');
...
define('IMAGE_BUTTON_DELETE_RECURRENT_ORDER', 'Supprimer la commande récurrente');
...
*/
define('FOOTER_TEXT_BODY', 'Copyright &copy; 2007 <a href="http://www.oscommerce.com" target="_blank">osCommerce</a><br>Powered by <a href="http://www.oscommerce.com" target="_blank">osCommerce</a>');
?>
