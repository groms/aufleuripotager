...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
  <tr class="header">
    <td valign="middle">
      <?php echo '<a href="' . tep_href_link(FILENAME_DEFAULT) . '">' . tep_image(DIR_WS_IMAGES . 'local.jpg', 'Aufleuripotager') . '</a>'; ?>
    </td>
    <td align="right" valign="bottom">
      <table border="0" width="100%" cellspacing="0" cellpadding="0">
        <tr class="header" valign="top">
          <td align="right">&nbsp;<a href="http://aufleuripotager.weebly.com" STYLE="background-image: url(http://aufleuripotager.weebly.com/image.jpg);text-decoration: none;color: #ffffff;font-weight:bold;font-family: verdana, arial, sans-serif;font-size: 11px;">&nbsp;Retour sur le site Aufleuripotager&nbsp;</a></td>
          <td align="right">&nbsp;</td>
        </tr>
        <tr class="header" valign="top">
          <td colspan="2">&nbsp;</td>
