...
// class constructor
    function payment($module = '') {
      global $payment, $language, $PHP_SELF, $doc_root, $subpath;
      ...
      if (defined('MODULE_PAYMENT_INSTALLED') && tep_not_null(MODULE_PAYMENT_INSTALLED)) {
        ...
        for ($i=0, $n=sizeof($include_modules); $i<$n; $i++) {
          include($doc_root . $subpath . DIR_WS_LANGUAGES . $language . '/modules/payment/' . $include_modules[$i]['file']);
          include($doc_root . $subpath . DIR_WS_MODULES . 'payment/' . $include_modules[$i]['file']);
