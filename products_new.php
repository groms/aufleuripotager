...
<?php
  ...
  if (!clientCanBuyGA()) {
    ...
    $products_new_query_raw .= " and p.group_id = 0 ";  
  }
...
?>
          <tr>
            <td width="<?php echo SMALL_IMAGE_WIDTH + 10; ?>" valign="top" class="main"><?php echo '<a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $products_new['products_id']) . '">' . tep_image(DIR_WS_CATALOG_IMAGES . $products_new['products_image'], $products_new['products_name'], SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT, '', PRODUCT_LISTING_MAX_IMAGE_SIZE) . '</a>'; ?></td>
